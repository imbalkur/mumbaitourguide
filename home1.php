...
<div>
<img src="images/mumbai.jpg" class="mumimg" height="400px" width="100%" alt="Gateway of india and taj"> </img>
</div>
...
Since Mumbai is situated right beside the Arabian Sea, there are various promenades where you just sit back and relax and feel the breeze on your face. <br /><br />
Marine Drive is one such promenade where you can sit with your feet dangling over the ledge, and enjoy a beautiful sunset against the backdrop of the roaring waves of the Arabian sea. When in Mumbai, don't forget to visit Bandra, which is home to most of the Bollywood stars, and is a laid-back suburb which houses many bars and nightclubs where you can experience the best of Mumbai's nightlife.<br /><br />
...
<div class="contact" id="contact">
    ...
    <form action="home1.php" method="POST" class="formcontact">
      ...
      <input class="box" type="text" placeholder="Email" required name="email"><br /><br />
