...
Pune<br />
Gender: Female<br />
Pricing Per Group:<br />
1 to 3 people: USD $32.00 Per Hour<br />
4 to 8 people: USD $39.00 Per Hour<br />
9 to 12 people: USD $45.00 Per Hour<br />
13 to 20 people: USD $51.00 Per Hour<br /><br />
Fixed Rates:<br />
USD $125.00 up to 3 people (8 hours max)<br />
USD $185.00 up to 5 people (8 hours max)<br />
USD $245.00 up to 9 people (8 hours max)<br />
USD $335.00 up to 14 people (8 hours max)<br />
USD $450.00 up to 20 people (8 hours max)<br />
</div>
</div>

<div style="padding:20px">
  <button class="viewbtn" onclick="on()">View Detail</button>
</div>
 <p><button id="button" class="button" onclick="document.getElementById('id01').style.display='block'" style="width:100%" disabled>Book Now</button></p>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="">
    <div class="container">
      ...
      <div class="clearfix">
        <button type="submit" class="bookbtn" disabled>Book</button>
      </div>
    </div>
  </form>
</div>
...
<!--card2-->
<div class="card">
  <img src="images/amod.jpg" style="width:30%" align="left" style="padding-right:10px;">
  <h1>Amod</h1>
...
Age: 55<br /><br /><br />
Tour guide services/sample itinerary:<br />
1) Ajanta , Ellora and Aurangabad sightseeing ( three days)<br />
2) Mumbai , Aurangabad Ajanta Ellora Pitalkhora ( four days)<br />
3) Ancient Buddhist monuments in Maharashtra ( upto six days)<br />
Apart from these custom theme based tours can also be arranged<br /><br />
Pricing Per Group:<br />

1 to 4 people: USD $15.00 Per Hour<br />
5 to 10 people: USD $18.00 Per Hour<br />
11 to 20 people: USD $21.00 Per Hour<br /><br />
Fixed Rates:<br />

USD $80.00 up to 4 people (8 hours max)<br />
USD $100.00 up to 20 people (8 hours max)
</div>
</div>

<div style="padding:20px">
  <button class="viewbtn1" onclick="on1()">View Detail</button>
</div>
  <p><button id="button1" class="button1" onclick="document.getElementById('id02').style.display='block'" style="width:100%;" disabled>Book Now</button></p>
...
<div id="id02" class="modal1">
  ...
  <form class="modal-content1" action="">
    <div class="container1">
      ...
      <div class="clearfix">
        <button type="submit" class="bookbtn1" disabled>Book</button>
      </div>
    </div>
  </form>
</div>
...
<div id="rtg" class="tabcontent">
  ...
  <form action="" method="">
	...
	<label for="experience"><b>Tour Guide Experience:</b><label >
	...
	<input id="cert" type="radio" name="cert" readonly>Yes
	<input id="cert" type="radio" name="cert" readonly>No<br /> <br />
	<button class="tgsubmit" id="tgsubmit" type="submit" disabled>Submit</button>
	Please <a href="login.php">Login</a> OR <a href="register.php">register</a> yourself
   </form>
